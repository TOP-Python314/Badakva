def pick_resistors(num: int) -> dict:
    ...
    list1 = list(nominals['E6'] + (num,))
    list1.sort()   
    list2 = list(nominals['E12'] + (num,))
    list2.sort()    
    list3 = list(nominals['E24'] + (num,))
    list3.sort()    
    list4 = list(nominals['E48'] + (num,))
    list4.sort()
    list5 = list(nominals['E96'] + (num,))
    list5.sort()
    
    list_tuples = []
    list_tuples.append(list1)
    list_tuples.append(list2)
    list_tuples.append(list3)
    list_tuples.append(list4)
    list_tuples.append(list5)
    list_resist = []
